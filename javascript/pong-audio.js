...
export var adventureMusic = new soundFile("Epic Battle Music Epic Dramatic Background Music Copyright Free Battle Music Light Of Darkness.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = -16;

export var villageMusic = new soundFile("Epic Battle Music Epic Dramatic Background Music Copyright Free Battle Music Light Of Darkness.mp3");
